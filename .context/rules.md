...
*This document is part of the `.context/` directory and defines strict guidelines that must be followed by all contributors and AI systems working on this project.*
