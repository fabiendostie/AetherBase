...
*This document is part of the `.context/` directory following TELIS methodology - use RAG (Retrieval Augmented Generation) techniques to select and inject relevant portions dynamically.*
