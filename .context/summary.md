...
4. **Tiered Detail**: High-level summary with expandable sections
...
When resuming work or starting new sessions:

1. **Load Summary First** (this document)
2. **Check Active Tasks** (from task tracking system)
3. **Review Recent Decisions** (decision log above)
4. **Scan Open Issues** (known issues section)
5. **Progressive Detail** (request specific shards as needed)

This prevents context overload while ensuring coherence.
